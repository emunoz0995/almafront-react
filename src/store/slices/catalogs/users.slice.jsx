...
export const getUsersThunk = () => dispatch => {
    ...
    axios.get(`http://172.26.1.254:4000/users`)
...
export const getUserThunk = (user_id) => dispatch => {
    ...
    axios.get(`http://172.26.1.254:4000/users/${user_id}`)
...
export const createUserThunk = (data) => dispatch => {
    ...
    axios.post(`http://172.26.1.254:4000/users/user`, data)
...
export const updateUserThunk = (user_id, data) => dispatch => {
    ...
    axios.put(`http://172.26.1.254:4000/users/user/${user_id}`, data)
...
export const deleteUserThunk = (user_id) => dispatch => {
    ...
    axios.delete(`http://172.26.1.254:4000/users/user/${user_id}`)
